...
use contracts::merkle_tree::{
    IMerkleTreeWithHistoryDispatcher, IMerkleTreeWithHistoryDispatcherTrait,
    hashes::PoseidonCHasher, constants,
};

const MERKLE_TREE_SIZE: usize = 2; // for testing only
